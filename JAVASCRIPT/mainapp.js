...
// btnSort.addEventListener('click', function () {
//   if (!sorted) {
//     // i need to create a copy, otherwise the original array will be mutated, and  don't want that
//     printMovements(currentAccount.movements.slice().sort((a, b) => a - b));
...
//   }
//   //i need to flip sorted, so that in the next click, the opposite happens
//   sorted = !sorted;
// });
